      ...
      <div className="relative isolate flex min-h-screen flex-col overflow-hidden">
        ...
        <main className="relative mx-auto flex w-full max-w-7xl flex-1 flex-col px-6 pb-20 pt-8 sm:px-10 lg:px-14">
          <header className="mx-auto flex w-full max-w-6xl items-center justify-between gap-4">
            ...
            <button
              type="button"
              className="inline-flex items-center gap-1.5 rounded-full border border-white/30 bg-white px-3.5 py-2 text-xs font-medium text-black transition-colors hover:bg-[#e9e9ef] sm:gap-2 sm:px-5 sm:py-2.5 sm:text-sm"
            >
              Leaderboard
